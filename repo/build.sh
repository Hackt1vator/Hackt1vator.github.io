...
for d in "${dirs[@]}"; do
    set_arch_vars "$d"
    apt-ftparchive \
        -o APT::FTPArchive::Release::Origin="hackt1vator" \
        -o APT::FTPArchive::Release::Label="hackt1vator" \
        -o APT::FTPArchive::Release::Suite="stable" \
        -o APT::FTPArchive::Release::Version="1.0" \
        -o APT::FTPArchive::Release::Codename="hackt1vator-repo" \
        -o APT::FTPArchive::Release::Architectures="iphoneos-arm iphoneos-arm64" \
        -o APT::FTPArchive::Release::Components="main" \
        -o APT::FTPArchive::Release::Description="hackt1vator's official repo" \
